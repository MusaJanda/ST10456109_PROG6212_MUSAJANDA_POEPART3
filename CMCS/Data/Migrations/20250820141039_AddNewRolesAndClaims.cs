...
{
    /// <inheritdoc />
    public partial class AddNewRolesAndClaims : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerId = table.Column<int>(type: "int", nullable: false),
                    ApprovedByCoordinatorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ApprovedByCoordinatorId,
                        principalTable: "ProgrammeCoordinators",
                        principalColumn: "CoordinatorId");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Claims_ApprovedByCoordinatorId",
                table: "Claims",
                column: "ApprovedByCoordinatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Claims_ApprovedByManagerId",
                table: "Claims",
